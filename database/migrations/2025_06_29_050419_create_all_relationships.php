...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Update posts table with user_id foreign key
        Schema::table('posts', function (Blueprint $table) {
            $table->unsignedBigInteger("user_id");
            $table->foreign("user_id")->references("id")->on("users");
        });

        // Don't add post_id, user_id, or parent_comment_id again here — they are already in the comments migration!
        ...
        // Update media table with post_id foreign key
